...
module normalization                                                         ! module "normalization routines"
...
contains                                                                     ! start
  ...
  subroutine normalize_wavefunctions(psi, dx)                               ! Subroutine to normalize each wavefunction psi(x)
    ...
    real(8), intent(in) :: dx                                                ! Input of grid spacing
    real(8), intent(inout) :: psi(:,:)                                       ! Input/output of matrix of wavefunctions (nstates * Nx)
...
end module normalization                                                     ! End whole program
